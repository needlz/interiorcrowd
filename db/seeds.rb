...
Appeal.delete_all
Appeal.create(id: 1, first_name: 'feminine', second_name: 'masculine')
Appeal.create(id: 2, first_name: 'elegant', second_name: 'eclectic')
Appeal.create(id: 3, first_name: 'traditional', second_name: 'modern')
Appeal.create(id: 4, first_name: 'conservative', second_name: 'bold')
Appeal.create(id: 5, first_name: 'muted', second_name: 'colorful')
Appeal.create(id: 6, first_name: 'timeless', second_name: 'trendy')
Appeal.create(id: 7, first_name: 'appeal7min', second_name: 'appeal7max')
Appeal.create(id: 8, first_name: 'appeal8min', second_name: 'appeal8max')
Appeal.create(id: 9, first_name: 'appeal9min', second_name: 'appeal9max')
