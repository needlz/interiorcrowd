class @ContestEditing extends InlineEditor
  ...
  previewCallbacks:
    ...
    space_pictures: ->
      PicturesZoom.initGallery(
        enlargeButtonSelector: '[data-option=space_pictures] a.enlarge',
        galleryName: 'space')
    example_pictures: ->
      PicturesZoom.initGallery(
        enlargeButtonSelector: '[data-option=example_pictures] a.enlarge',
        galleryName: 'examples')
